    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/drop-off-points/**").permitAll()
                        ...
                        // Role-gated URL patterns (further secured by @PreAuthorize on controllers)
                        .requestMatchers("/api/consumer/**").hasRole("CONSUMER")
                        .requestMatchers("/api/facility/**").hasRole("FACILITY_STAFF")
